...
#### `CommandNXT.java`
Wrapper for NXT-style controllers (competition driver controllers):
...
- Other physics-related utilities
...
**Replay:**
- Place log file in `logs/` directory
- Set `Constants.simMode = Mode.REPLAY`
- Run simulation to replay log
...
1. **Create paths in PathPlanner** (save to `src/main/deploy/pathplanner/`)
...
This project incorporates code and architectural patterns from **FRC 6328 (Mechanical Advantage)**. Code from FRC 6328 is used under the GNU General Public License v3.
